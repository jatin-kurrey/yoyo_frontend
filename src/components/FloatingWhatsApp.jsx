...
export default function FloatingWhatsApp() {
    ...
    return (
        ...
        >
            ...
            <span className="absolute right-20 bg-white text-gray-800 text-xs font-black uppercase tracking-widest px-4 py-2 rounded-2xl shadow-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap border border-gray-100">
                Chat on WhatsApp
            </span>
            <span className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-40 -z-10"></span>
        </a>
    );
}
